...
| :--- | :--- | :--- |
| **🎰 Vegas Gambling Analysis** | Vectors, naming, vector arithmetic | 3 |
| **⭐ Star Wars Box Office** | Matrices, `rowSums`/`colSums`, `cbind` | 3 |
| **📋 Student Survey Analysis** | Data Frames, Factors, Lists | 4 |
...
| Tool | Usage |
| :--- | :--- |
| **R (v4.0+)** | Core language for all statistical analysis. |
| **RStudio** | Integrated Development Environment (IDE) for running scripts. |
| **ggplot2** | Primary library used for all professional data visualizations. |
| **tidyr** | Used for data reshaping and preparation. |
